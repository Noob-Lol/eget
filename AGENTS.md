...
This project is indexed by GitNexus as **eget** (7389 symbols, 17082 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
